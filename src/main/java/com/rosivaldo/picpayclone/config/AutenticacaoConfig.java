package com.rosivaldo.picpayclone.config;

import com.rosivaldo.picpayclone.filters.AutenticacaoTokenFilter;
import com.rosivaldo.picpayclone.repositories.UsuarioRepository;
import com.rosivaldo.picpayclone.services.impl.AutenticacaoService;
...
@Configuration
@EnableWebSecurity // ABILITANDO O WEB SECURITY DO SPRING
public class AutenticacaoConfig extends WebSecurityConfigurerAdapter {
  ...
  @Override
  @Bean // BEAN PARA INJETAR O AUTHENTICATIONMANAGER LA NO CONTROLLER
